-- =====================================================
-- Migration 045: Habilitar Edição e Inclusão Inline para Testes
-- Adiciona ação 'editar' nas ações da tabela
-- =====================================================

-- Atualizar config_funcionalidades para incluir editar nas ações da tabela
...
SET config_funcionalidades = '{
  ...
  "tabela": {
    ...
    "acoes": ["ver", "editar", "marcar_concluido", "teams"],
    "linha_clicavel": true
  },
  "metricas": {
    "habilitado": true,
  ...
  "modal_detalhe": {
    ...
    "secoes": [
      ...
      { "tipo": "lista", "campo": "passos", "titulo": "Passo a Passo", "ordenada": true, "delimitador": "|" },
      { "tipo": "bloco", "campo": "resultado_esperado", "titulo": "Resultado Esperado" },
      { "tipo": "bloco", "campo": "resultado_obtido", "titulo": "Resultado Obtido", "condicional": true, "cor_status": true },
      { "tipo": "bloco", "campo": "observacoes", "titulo": "Observacoes", "condicional": true, "cor": "warning" }
    ],
    "acoes_rodape": ["editar", "marcar_concluido", "marcar_falhou", "marcar_pendente", "teams"]
  },
  "acoes_lote": {
    "exportar_csv": { "habilitado": true, "campos": ["codigo", "nome", "categoria", "status", "sistema", "prioridade"] }
  },
  "teams": { "habilitado": true, "tipo": "teste", "titulo": "📋 Teste: {codigo} - {nome}", "facts": ["status", "categoria", "sistema", "prioridade", "resultado_esperado"] },
...
-- Verificar resultado
SELECT id, codigo, nome FROM projeto_entidades WHERE projeto_id = 5 AND codigo = 'testes';
