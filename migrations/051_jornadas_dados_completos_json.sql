...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'AMD Cross Company';

-- =============================================================================
-- Jornada: Áreas de Vendas
  ...
  "canais_venda": [
    {
      "código": "20",
      "nome": "Industria",
      "descrição": "Clientes industriais - CONFIRMADO na reunião 03/12 (Leandro: ''Industria, distribuição e consumo'')",
      "fonteConfirmação": "Reunião 03/12/2025",
      "exemploCNAE": [
        "Produção de artefatos estampados de metal",
        "Siderurgia",
        "Fabricação de máquinas"
      ],
      "critério": "CNAE de atividade industrial"
    },
    {
      "código": "25",
      "nome": "Casos Especiais",
      "descrição": "Mencionado na reunião 10/12 por Leandro",
      "fonteConfirmação": "Reunião 10/12/2025",
      "requerAprovação": true,
      "critério": "Aprovação especial da diretoria"
    },
    {
      "código": "30",
      "nome": "Distribuição",
      "descrição": "Distribuidores - CONFIRMADO na reunião 03/12 (Leandro: ''Industria, distribuição e consumo'')",
      "fonteConfirmação": "Reunião 03/12/2025",
      "exemploCNAE": [
        "Comércio atacadista de defensivos agrícolas, adubos, fertilizantes",
        "Comércio varejista de materiais de construção"
      ],
      "critério": "CNAE de comércio"
    },
    {
      "código": "40",
      "nome": "Consumo",
      "fonteConfirmação": "Reunião 03/12/2025 - Leandro: ''Industria, distribuição e consumo''",
      "descrição": "Pessoa Física ou pequenas empresas sem fins de revenda",
      "aplicaPF": true,
      "critério": "Pessoa Física ou empresa sem revenda"
    }
  ],
  "detalhes": {
    "canais": {
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Áreas de Vendas';

-- =============================================================================
-- Jornada: Autoatendimento
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Autoatendimento';

-- =============================================================================
-- Jornada: Cadastro de Cliente
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Cadastro de Cliente';

-- =============================================================================
-- Jornada: Rastreamento de Concorrentes
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Rastreamento de Concorrentes';

-- =============================================================================
-- Jornada: Gestão de Contatos
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Gestão de Contatos';

-- =============================================================================
-- Jornada: Cotação e Ordem de Vendas
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Cotação e Ordem de Vendas';

-- =============================================================================
-- Jornada: Documentos Fiscais
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Documentos Fiscais';

-- =============================================================================
-- Jornada: Financeiro/Crédito
...
SET dados = '{
  ...
  "areas_credito": [
    {
      "código": "BBA",
      "nome": "BBA - Limite Interno",
      "descrição": "Área de crédito interna - CONFIRMADO em 04/12 (Vanessa: ''Se for um limite de crédito para a área da BBA, que e um limite interno'')",
      "fonteConfirmação": "Reunião 04/12/2025 - Vanessa"
    },
    {
      "código": "CSP",
      "nome": "CSP - Supply (Belgo Cash)",
      "descrição": "Área de crédito Supply - CONFIRMADO em 03/12 e 04/12 (Leandro: ''a CSP a da supplier'')",
      "fonteConfirmação": "Reuniões 03/12 e 04/12/2025"
    },
    {
      "código": "DBA",
      "nome": "DBA - Distribuição",
      "descrição": "Área de crédito para distribuição - CONFIRMADO em 04/12 (Leandro: ''a DBA que e da distribuição''). Gerênciado pela propria Rede.",
      "fonteConfirmação": "Reunião 04/12/2025 - Leandro Pereira"
    },
    {
      "código": "ALPE",
      "nome": "ALPE",
      "descrição": "Área de crédito ALPE - CONFIRMADO em 04/12 (Leandro: ''a gente tem a da Alp'')",
      "fonteConfirmação": "Reunião 04/12/2025 - Leandro Pereira"
    }
  ],
  "detalhes": {
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Financeiro/Crédito';

-- =============================================================================
-- Jornada: Hub de Gestão OC
...
SET dados = '{
  ...
  "dados_tester": {
    ...
    "título": "Hub de gestão OC",
    "data": "10/11/2025",
    "funcionalidadeTestada": "Gerênciamento de membros de grupos de solução (LWC)",
    "perfisTestados": {
      "gestãoAnalista": {
        "perfil": "Gestão e Analista (Comercial)",
        "permissoes": [
          "Ver grupos",
          "Ver membros",
          "Adicionar membros"
        ...
        "fluxoTestado": [
          "Visualizar grupos com contagem de membros",
          "Visualizar membros com nomes, emails e funções",
          "Adicionar novo membro via botao ''Novo Membro''",
          "Receber mensagem ''Sucesso - Novo membro adicionado ao grupo''"
        ]
      },
      "gestor": {
        "perfil": "Gestor",
      ...
      "analistaRestrito": {
        ...
        "camposVisiveis": [
          ...
          "Membros",
          "E-mail",
          "Função e Permissão do Grupo de Negócios"
        ]
      }
    },
    "validaçõesTestadas": {
      "duplicidade": {
        "cenario": "Tentar adicionar usuário ja existente no grupo",
        "mensagem": "usuário ja existe",
        "resultado": "Bloqueado"
      },
      "delecaoGrupo": {
        "regra": "Para deletar grupo, deve remover todos membros primeiro",
        "validação": "Sistema bloqueia delecao de grupo com membros"
      },
      "buscaUsuário": {
        "critérios": [
          "Por email",
        ...
        "resultado": "Busca funciona mesmo para perfil restrito"
      }
    },
    "gruposTestados": [
      "Comercial",
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Hub de Gestão OC';

-- =============================================================================
-- Jornada: Portal Logístico
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Portal Logístico';

-- =============================================================================
-- Jornada: Market Share e Concorrentes
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Market Share e Concorrentes';

-- =============================================================================
-- Jornada: Restrições Logísticas
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Restrições Logísticas';

-- =============================================================================
-- Jornada: Workflow Pricing
...
WHERE projeto_id = 5
  AND entidade_id = 18
  AND json_extract(dados, '$.nome') = 'Workflow Pricing';
